...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('status', postgresql.ENUM('waiting', 'active', 'closed', name='lobbystatus', create_type=False), nullable=False),
    ...
    op.create_table(
        'tasks_pool',
        sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('type', postgresql.ENUM('truth', 'dare', name='tasktype', create_type=False), nullable=False),
        sa.Column('is_18_plus', sa.Boolean(), nullable=False, server_default='false'),
        sa.Column('text', sa.Text(), nullable=False),
        sa.Column('media_required', postgresql.ENUM('none', 'photo', 'video_note', name='mediarequired', create_type=False),
    ...
    op.create_table(
        ...
        sa.Column('ban_type', postgresql.ENUM('warn', 'temp', 'permanent', name='bantype', create_type=False), nullable=True),
